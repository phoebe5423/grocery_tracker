...
CREATE TABLE `In_List` (
  ...
  CONSTRAINT `In_List_ibfk_1` FOREIGN KEY (`StoreID`) REFERENCES `Store` (`StoreID`)
...
LOCK TABLES `In_List` WRITE;
/*!40000 ALTER TABLE `In_List` DISABLE KEYS */;
/*!40000 ALTER TABLE `In_List` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-04-29 17:51:21
